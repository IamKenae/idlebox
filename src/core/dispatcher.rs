use crate::applets::{
    ...
    Sha1sumApplet, Sha256sumApplet, Sha512sumApplet, ShellApplet, SleepApplet, SortApplet,
    SuApplet, TailApplet, TarApplet, TeeApplet, TestApplet, TouchApplet, TrApplet, TreeApplet,
    TrueApplet, UnameApplet, UniqApplet, UnzipApplet, UptimeApplet, WcApplet, WhoamiApplet,
    ZcatApplet,
};
